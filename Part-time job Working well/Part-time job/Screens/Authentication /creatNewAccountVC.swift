...
class creatNewAccountVC: UIViewController {
  ...
  private func setupUserInterface() {
    ...
    NSLayoutConstraint.activate([
      ...
      categorySegmentedControl.topAnchor.constraint(equalTo: passwordTF.bottomAnchor, constant: 15),
  ...
  func transitionToHome() {
    let homeViewController = storyboard?.instantiateViewController(identifier: K.StoryBoard.homeNavigationController) as! UINavigationController
